...
},{"../dist/chart.esm":"../node_modules/chart.js/dist/chart.esm.js"}],"../node_modules/process/browser.js":[function(require,module,exports) {
...
},{}],"../node_modules/immutability-helper/index.js":[function(require,module,exports) {
...
},{"process":"../node_modules/process/browser.js"}],"../node_modules/@opendatasoft/api-client/dist/api-client.esm.js":[function(require,module,exports) {
var define;
...
exports.string = exports.one = exports.fromMonitoring = exports.fromDataNetwork = exports.fromCatalog = exports.field = exports.dateTime = exports.date = exports.all = exports.Query = exports.ApiClient = void 0;
...
var ApiError = /*#__PURE__*/function (_Error) {
  ...
  function ApiError(response, details) {
    ...
    _this = _Error.call(this, JSON.stringify(details)) || this;
...
var UserError = /*#__PURE__*/function (_ApiError) {
  _inheritsLoose(UserError, _ApiError);

  function UserError() {
    return _ApiError.apply(this, arguments) || this;
  }
...
var AuthenticationError = /*#__PURE__*/function (_UserError) {
  _inheritsLoose(AuthenticationError, _UserError);

  function AuthenticationError() {
    return _UserError.apply(this, arguments) || this;
  }
...
var NotFoundError = /*#__PURE__*/function (_UserError2) {
  _inheritsLoose(NotFoundError, _UserError2);

  function NotFoundError() {
    return _UserError2.apply(this, arguments) || this;
  }
...
var ServerError = /*#__PURE__*/function (_ApiError2) {
  _inheritsLoose(ServerError, _ApiError2);

  function ServerError() {
    return _ApiError2.apply(this, arguments) || this;
  }

  return ServerError;
}(ApiError);

var API_KEY_AUTH_TYPE = 'ApiKey'; // Using the UMD bundle in ObservableHQ, the error "ReferenceError: global is not defined" is returned.
// ... I'm not sure why it behaves that way, but this fixes the issue:

var _global = typeof global !== 'undefined' ? global : // eslint-disable-next-line no-restricted-globals
typeof self !== 'undefined' ? // eslint-disable-next-line no-restricted-globals
...
var ApiClient = /*#__PURE__*/function () {
  ...
  function ApiClient(options) {
    ...
    var fetch = (options == null ? void 0 : options.fetch) || (_global == null ? void 0 : _global.fetch);
    ...
    var domain = (options == null ? void 0 : options.domain) || (_global == null ? void 0 : (_global$location = _global.location) == null ? void 0 : _global$location.origin);
  ...
  _proto.get = /*#__PURE__*/function () {
    var _get = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee(query, options) {
      var config, path, url, headers, request, fetch, fetchResponse, data, errorData, response;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 16:
              ...
              _context.next = 20;
              return config.interceptResponse(fetchResponse);
...
function buildConfig(apiClientOptions, defaultConfig) {
  ...
  return (0, _immutabilityHelper.default)(defaultConfig, {
    $merge: newConfig
  });
}
...
var Query = /*#__PURE__*/function () {
  function Query(path, init) {
    if (path === void 0) {
      path = '';
    }

    this.searchParams = undefined;
    this.params = init ? _extends({}, init) : {};
    this.path = path;
  }
    ...
    if (this.searchParams === undefined) {
      ...
      for (var name in this.params) {
        ...
        if (typeof value === 'string') {
          ...
          for (var _iterator = _createForOfIteratorHelperLoose([].concat(value).sort()), _step; !(_step = _iterator()).done;) {
            var itValue = _step.value;
  ...
  _proto.set = function set(name, value) {
    ...
    var newParams = (0, _immutabilityHelper.default)(this.params, {
      $merge: (_$merge = {}, _$merge[name] = value, _$merge)
    });
  ...
  _proto.update = function update(name, value) {
    ...
    var newValue = '';
    if (typeof value === 'string') newValue = value;else if (typeof current === 'string') newValue = value(current || '');else newValue = value((current == null ? void 0 : current[0]) || '');
    return this.set(name, newValue);
  };

  _proto.append = function append(name, value) {
    var currentValue = this.params[name];
    var newValue = currentValue === undefined ? [value] : typeof currentValue === 'string' ? [currentValue, value] : [].concat(currentValue, [value]);
    return this.set(name, newValue);
  };

  _proto.select = function select(expressions) {
    return this.update('select', expressions);
  };

  _proto.where = function where(filters) {
    return this.update('where', filters);
  };

  _proto.groupBy = function groupBy(expressions) {
    return this.update('group_by', expressions);
  };

  _proto.orderBy = function orderBy(expressions) {
  ...
  _proto.limit = function limit(_limit) {
    ...
    return this.update('limit', function (current) {
      return _limit(Number(current)).toString();
    });
  };

  _proto.offset = function offset(_offset) {
    if (typeof _offset === 'number') return this.set('offset', _offset.toString());
    return this.update('offset', function (current) {
      return _offset(Number(current)).toString();
    });
  };

  _proto.facet = function facet(_facet) {
    return this.append('facet', _facet);
  };

  _proto.refine = function refine(_refine) {
    return this.append('refine', _refine);
  };

  _proto.exclude = function exclude(_exclude) {
    return this.append('exclude', _exclude);
  };

  _proto.lang = function lang(_lang) {
  ...
  return function () {
    return {
      ...
      aggregates: function aggregates() {
        return new Query(source + "/aggregates/");
      },
      facets: function facets() {
        return new Query(source + "/facets/");
      },
      datasets: function datasets() {
        return new Query(source + "/datasets/");
      },
      dataset: function dataset(datasetId) {
        return {
          itself: function itself() {
            return new Query(source + "/datasets/" + datasetId + "/");
          },
          aggregates: function aggregates() {
            return new Query(source + "/datasets/" + datasetId + "/aggregates/");
          },
          facets: function facets() {
            return new Query(source + "/datasets/" + datasetId + "/facets/");
          },
          records: function records() {
            return new Query(source + "/datasets/" + datasetId + "/records/");
          }
        };
      }
    };
...
var fromCatalog = /*#__PURE__*/root('catalog');
exports.fromCatalog = fromCatalog;
var fromMonitoring = /*#__PURE__*/root('monitoring');
exports.fromMonitoring = fromMonitoring;
var fromDataNetwork = /*#__PURE__*/root('opendatasoft');
exports.fromDataNetwork = fromDataNetwork;
...
var date = function date(_date) {
  return "date'" + _date.toISOString().split('T')[0] + "'";
};
...
exports.one = one;
},{"immutability-helper":"../node_modules/immutability-helper/index.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _auto = _interopRequireDefault(require("chart.js/auto"));

var _apiClient = require("@opendatasoft/api-client");
...
var client = new _apiClient.ApiClient({
  domain: "documentation-resources"
}); // Create the query to run.

var query = (0, _apiClient.fromCatalog)() // From the domain catalog
...
client.get(query).then(function (res) {
  var _iterator = _createForOfIteratorHelper(res.aggregations),
      _step;
...
},{"chart.js/auto":"../node_modules/chart.js/auto/auto.esm.js","@opendatasoft/api-client":"../node_modules/@opendatasoft/api-client/dist/api-client.esm.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
